import SpecialSliderClient from "./SpecialSliderClient";

const SpecialSlider = async () => {
  const products = [
    {
      id: "1",
      title: "قهوه ساز برقی سینبو مدل SCM 2928 با بدنه سرامیکی",
      image:
        "https://halochin.ir/coffee-store/wp-content/uploads/2023/11/product-4-min.png",
      price: "2130000",
      takhfif: "16%",
      orgprice: "1790000",
    },
    {
      ...
      image:
        "https://halochin.ir/coffee-store/wp-content/uploads/2023/11/product-3.png",
      price: "3400000",
      takhfif: "19%",
      orgprice: "2750000",
    },
    {
      ...
      image:
        "https://halochin.ir/coffee-store/wp-content/uploads/2023/11/product-6-min.png",
      price: "195000",
      takhfif: "28%",
      orgprice: "140000",
    },
    {
      ...
      image:
        "https://halochin.ir/coffee-store/wp-content/uploads/2023/11/product-8-min.png",
      price: "279000",
      takhfif: "15%",
      orgprice: "236000",
    },
    {
      ...
      title: "دانه قهوه ترکیبی 250 گرم HOUSE Blend 100% Arabica",
      image:
        "https://halochin.ir/coffee-store/wp-content/uploads/2023/11/product-5-min.png",
      price: "201000",
      takhfif: "10%",
      orgprice: "152000",
    },
    ...
    <div className="container mx-auto">
      ...
      <div className="mt-24 flex justify-center items-center">
        <div className="flex items-center content-center">
          ...
          <h3 className="text-5xl font-rokh">فروش ویژه</h3>
          <svg
            className="w-10"
            xmlns="http://www.w3.org/2000/svg"
            width="31"
      ...
      {/* Slider */}
      <SpecialSliderClient products={products} />
    </div>
  );
};

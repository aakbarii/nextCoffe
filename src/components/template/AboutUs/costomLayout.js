...
function CostomLayout() {
  ...
  const cardsData = [
    {
      imageSrc:
        "https://halochin.ir/coffee-store/wp-content/uploads/2023/11/Frame.png",
      title: "بهترین نژاد های قهوه",
      description:
        "لورم ایپسوم متن ساختگی با تولید سادگی از نامفهوم از صنعت چاپ می باشد.",
    },
    {
      imageSrc:
        "https://halochin.ir/coffee-store/wp-content/uploads/2023/11/Frame2.png",
      title: "امکان خرید عمده",
      description:
        "لورم ایپسوم متن ساختگی با تولید سادگی از نامفهوم از صنعت چاپ می باشد.",
    },
    {
      ...
      <div className="flex justify-end mt-10 gap-x-10">
        {cardsData.map((card, index) => (
          <AboutCard
            ...
            additionalStyles={index % 2 !== 0 ? "mt-8" : ""}
          />
        ))}
      </div>
    </div>
